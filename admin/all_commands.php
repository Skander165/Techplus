...
$sql = "SELECT id, user.prenom_u, user.nom_u, quantity, total FROM commande JOIN user on user_id = id_u LIMIT $offset, $no_of_records_per_page";
        ...
        <table class="table table-hovered">
            ...
            <tbody>
                ...
                if (isset($_GET['search']) && $_GET['search'] != '') {
                    include "./queries/search/search_command.php";
                } else {
