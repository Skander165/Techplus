...
<body>
    ...
    <div class="container">
        ...
        <table class="table table-hovered">
            ...
            <tbody>
                ...
                if (isset($_GET['search']) && $_GET['search'] != '') {
                    include "./queries/search/search_computer.php";
                } else {
        ...
        ?>
        <h6 style="text-align:center;"><a data-toggle="modal" data-target="#add_computer_modal" href="#" class="link" target="_blank">+ New Laptop</a></h6>

    </div>
    <!-- Add Computer Modal start -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="./queries/add/add_laptop.php">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Computer Name</label>
                                    <input type="text" name="name" class="form-control" placeholder="Enter Computer Name">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Brand Name</label>
                                    <input type="text" name="marque" class="form-control" placeholder="Enter Computer Brand">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Computer Description</label>
                                    <textarea class="form-control" name="description" placeholder="Enter Computer desc"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Computer Quantity</label>
                                    <input type="number" name="quantite" class="form-control" placeholder="Enter Computer Quantity">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Computer Price</label>
                                    <input type="number" name="price" class="form-control" placeholder="Enter Computer Price">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Computer Keywords <small>(eg: apple, iphone, mobile)</small></label>
                                    <input type="text" name="keywords" class="form-control" placeholder="Enter Computer Keywords">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Computer Image <small>(format: jpg, jpeg, png)</small></label>
                                    <input type="file" name="image" class="form-control">
                                </div>
                            </div>
                            <div class="col-12">
                                <button type="Submit" class="btn btn-primary add-computer btn-danger">Add Computer</button>
                            </div>
                        </div>
                    </form>
                </div>
