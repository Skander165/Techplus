            ...
            <div class="carousel-item active">
              <div class="row">
                ...
                if (isset($_GET['search']) && $_GET['search'] != '') {
                  include "./search/search_printer.php";
                } else {
                    ...
                    <div class="col-md-4">
                      <div class="single-box">
                        ...
                        <div class="img-text">
                          ...
                          <a href="add_cart_pri.php?identifiant=<?php echo $row['id'] ;?>"><button class="img-btn btn btn-danger btn-xs" >Add To Cart</button></a>
                        </div>
                        <br>
                      </div>
                    </div>
